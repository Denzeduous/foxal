...
foreign kernal32 {
    @(link_name="SetConsoleTitle") set_console_title :: proc(lp_console_title: cstring) -> BOOL ---;
    ...
    @(link_name="WriteConsoleOutput") write_console_output :: proc(h_console_output          : win32.Handle,
                                                                   lp_buffer                 : rawptr,
                                                                   n_number_of_chars_to_write: win32.DWORD,
